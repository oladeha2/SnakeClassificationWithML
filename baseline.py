...
train_model(model=resnet, loss_function=loss_function, optimiser=optimizer, scheduler=lr_sched, num_epochs=25 ,train_data=train_loader, valid_data=valid_loader)